...
import com.ub.st.daos.negocio.DaoTipoObservacion;
 ...
 */
public class ManagerTipoObservacion extends ManagerSQL<TipoObservacion, Integer> {

    public ManagerTipoObservacion() {
        super(new DaoTipoObservacion());
    }
