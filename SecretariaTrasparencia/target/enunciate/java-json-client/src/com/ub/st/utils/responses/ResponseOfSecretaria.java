...
public class ResponseOfSecretaria implements java.io.Serializable {

  @JsonIgnore
  private com.ub.st.entities.negocio.Secretaria _data;
  @JsonIgnore
  ...
  public com.ub.st.entities.negocio.Secretaria getData() {
    return this._data;
  }
   ...
   */
  @JsonProperty( value = "data", required = false )
  public void setData(com.ub.st.entities.negocio.Secretaria _data) {
    this._data = _data;
  }
