...
public class ResponseOfEnteFiscalizado implements java.io.Serializable {

  @JsonIgnore
  private com.ub.st.utils.responses.MetaData _meta;
  @JsonIgnore
  private com.ub.st.entities.negocio.EnteFiscalizado _data;
  ...
  public com.ub.st.entities.negocio.EnteFiscalizado getData() {
    return this._data;
  }
   ...
   */
  @JsonProperty( value = "data", required = false )
  public void setData(com.ub.st.entities.negocio.EnteFiscalizado _data) {
    this._data = _data;
  }
}
