...
public class ResponseOfTipoObservacion implements java.io.Serializable {

  @JsonIgnore
  private com.ub.st.entities.negocio.TipoObservacion _data;
  @JsonIgnore
  ...
  public com.ub.st.entities.negocio.TipoObservacion getData() {
    return this._data;
  }
   ...
   */
  @JsonProperty( value = "data", required = false )
  public void setData(com.ub.st.entities.negocio.TipoObservacion _data) {
    this._data = _data;
  }
