...
public class ResponseOfPrograma implements java.io.Serializable {

  @JsonIgnore
  private com.ub.st.entities.negocio.Programa _data;
  @JsonIgnore
  ...
  public com.ub.st.entities.negocio.Programa getData() {
    return this._data;
  }
   ...
   */
  @JsonProperty( value = "data", required = false )
  public void setData(com.ub.st.entities.negocio.Programa _data) {
    this._data = _data;
  }
