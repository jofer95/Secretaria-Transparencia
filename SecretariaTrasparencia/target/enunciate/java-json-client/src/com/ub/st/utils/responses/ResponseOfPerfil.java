...
public class ResponseOfPerfil implements java.io.Serializable {

  @JsonIgnore
  private com.ub.st.entities.negocio.Perfil _data;
  @JsonIgnore
  ...
  public com.ub.st.entities.negocio.Perfil getData() {
    return this._data;
  }
   ...
   */
  @JsonProperty( value = "data", required = false )
  public void setData(com.ub.st.entities.negocio.Perfil _data) {
    this._data = _data;
  }
