...
public class ResponseOfPermiso implements java.io.Serializable {

  @JsonIgnore
  private com.ub.st.entities.negocio.Permiso _data;
  @JsonIgnore
  ...
  public com.ub.st.entities.negocio.Permiso getData() {
    return this._data;
  }
   ...
   */
  @JsonProperty( value = "data", required = false )
  public void setData(com.ub.st.entities.negocio.Permiso _data) {
    this._data = _data;
  }
