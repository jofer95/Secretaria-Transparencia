...
public class ResponseOfAuditoria implements java.io.Serializable {

  @JsonIgnore
  private com.ub.st.entities.negocio.Auditoria _data;
  @JsonIgnore
  ...
  public com.ub.st.entities.negocio.Auditoria getData() {
    return this._data;
  }
   ...
   */
  @JsonProperty( value = "data", required = false )
  public void setData(com.ub.st.entities.negocio.Auditoria _data) {
    this._data = _data;
  }
