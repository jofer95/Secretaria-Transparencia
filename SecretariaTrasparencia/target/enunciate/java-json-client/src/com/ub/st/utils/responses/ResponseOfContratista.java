...
public class ResponseOfContratista implements java.io.Serializable {

  @JsonIgnore
  private com.ub.st.entities.negocio.Contratista _data;
  @JsonIgnore
  ...
  public com.ub.st.entities.negocio.Contratista getData() {
    return this._data;
  }
   ...
   */
  @JsonProperty( value = "data", required = false )
  public void setData(com.ub.st.entities.negocio.Contratista _data) {
    this._data = _data;
  }
