...
public class ResponseOfEstatusObservacion implements java.io.Serializable {

  @JsonIgnore
  private com.ub.st.entities.negocio.EstatusObservacion _data;
  @JsonIgnore
  ...
  public com.ub.st.entities.negocio.EstatusObservacion getData() {
    return this._data;
  }
   ...
   */
  @JsonProperty( value = "data", required = false )
  public void setData(com.ub.st.entities.negocio.EstatusObservacion _data) {
    this._data = _data;
  }
